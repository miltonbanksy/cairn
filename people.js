const peopleCultureCharacters = [ "Altruistic", "Artistic", "Curious", "Devious", "Enlightened", "Hardy", "Harmonious", "Inventive", "Mercantile", "Nomadic", "Reclusive", "Harmony", "Peace", "Power", "Purity", "Recognition", "Return", "Security", "Stability", "Unification", "Wealth" ];
const peopleCultureAmbitions = [ "Bounty", "Conquest", "Control", "Conversion", "Division", "Dominance", "Exploration", "Fealty", "Independence", "Knowledge", "Natural", "Religious", "Resilient", "Scholarly", "Stoic", "Struggling", "Traditional", "War-like", "Wealthy", "Xenophobic" ];
const peopleResources = [ "Food", "Fuel", "Gemstones", "Herbs", "Horses", "Knowledge", "Land", "Livestock", "Medicine", "Ore", "Skilled", "Skilled", "Spices", "Stone", "Textiles", "Tools", "Trade", "Trade", "Vessels", "Water", "Weapons", "Wood" ];
